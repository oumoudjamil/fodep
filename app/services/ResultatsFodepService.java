...
public interface ResultatsFodepService {
    ...
    boolean chargeResultat(String codeEtat, String codePoste, String libellePoste , String colonne1, Double colonne2,Double colonne3, String session_id, int mnt6, Double mnt7, Double mnt9) throws SQLException ;
